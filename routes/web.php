...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Guardians
    Route::delete('guardians/destroy', 'GuardiansController@massDestroy')->name('guardians.massDestroy');
    Route::post('guardians/media', 'GuardiansController@storeMedia')->name('guardians.storeMedia');
    Route::post('guardians/ckmedia', 'GuardiansController@storeCKEditorImages')->name('guardians.storeCKEditorImages');
